...
[Magento 2 Product Attachments](https://www.ulmod.com/magento-2-product-attachments.html)  is a Magento 2 extension that allows you to provides more details to your shoppers about the products they're interested to buy.

With Magento 2 Product Attachments, you can attach various types of downloadable files (eg. user manuals, licenses, warranties, video guides, price lists) right on product pages.

<a href="https://www.ulmod.com/magento-2-product-attachments.html"><img width="205" src="https://www.ulmod.com/media/wysiwyg/um-download-now1.png"></a>

## Key Features

* Create any number of attachments 
* Create any number of categories to categorize attachments in the frontend
* Support most popular formats such as jpg, jpeg, gif, png, bmp, txt, csv, htm, html, xml, css, doc, docx, xls, rtf, ppt, pdf, swf, flv, avi, wmv, mov, wav, mp3, zip and more
* Ability to insert attachments to the product, category, CMS pages, and any other pages
* Ability to upload one or multiples files at once,
* Ability to upload via drag-drop files 
* Ability to spseicnfy attachement in form of URL (external or internal attachement url)
* Restrict by customer group
* Display file size, units (auto, MB, or kb)
* Display the number of downloads
* Mobile-friendly
* Support multiple-stores


<img src="https://www.ulmod.com/media/ulmod/product_content/umprodatt-files.png">
<img src="https://www.ulmod.com/media/ulmod/product_content/umprodatt-cat.png">
<img src="https://www.ulmod.com/media/ulmod/product_content/umprodatt-upload.png">
<img src="https://www.ulmod.com/media/ulmod/product_content/umprodatt-admin.png">
